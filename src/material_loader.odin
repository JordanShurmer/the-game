...
test_load_materials_count :: proc(t: ^testing.T) {
	...
	testing.expect(t, len(table.materials) == 48, "expected 48 materials")
	testing.expect(t, len(table.names) == 48, "names must match materials")
	testing.expect(t, len(table.glyphs) == 48, "glyphs must match materials")
	testing.expect(t, len(table.decays_to) == 48, "decay table must match materials")
	testing.expect(t, len(table.burns_to) == 48, "burn table must match materials")
	testing.expect(t, len(table.crumbles_to) == 48, "crumble table must match materials")
	testing.expect(t, len(table.reaction_at) == 48 * 48, "reaction_at must be n*n")
	testing.expect(t, len(table.reacts) == 48, "reacts must match materials")
}
